    ...
    <main className="min-h-dvh grid lg:grid-cols-2">
      ...
      <section className="flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-md">
          ...
          <h1 className="mt-10 text-3xl sm:text-4xl font-semibold tracking-tight">Welcome back!</h1>
          ...
          {hasGoogle && (
            <div className="mt-8 space-y-5">
              <form action={googleAction}>
                <button className="w-full inline-flex items-center justify-center gap-2 rounded-md border px-3 py-2 bg-white text-gray-900">Sign in with Google</button>
              </form>
          ...
          <form action={loginAction} className="mt-8 space-y-5">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <a className="text-xs text-sky-600 hover:underline" href="#">Forgot password?</a>
              </div>
              <input
                id="password"
                name="password"
            ...
            <p className="text-center text-xs text-gray-600">
              New here? <a href="/signup" className="text-sky-600 hover:underline">Create an account</a>
            </p>
          </form>
        </div>
      </section>
      ...
      <section className="hidden lg:flex items-center justify-center bg-gray-50 p-10">
        ...
        <img src="/window.svg" alt="Login illustration" className="max-w-[520px] w-4/5" />
      </section>
    </main>
  );
}
